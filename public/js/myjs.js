var js_myjs = function () {
    ...
    jQuery(document).ready(function () {
        ...
        $('.add-co-applicant').click(function() {
			...
			if ($(".add-co-applicant").hasClass("open")) {
                $('#co-applicant').val("on");
            } else {
                $('.co-applicant-info').find('input').val('');
                $('.co-applicant-info').find('select').val('');
                $('#co-applicant').val("off");
            }
        });
		if ($("#co-applicant").val() == "on") {
            $('.add-co-applicant').toggleClass('open');
            $('.co-applicant-info').toggleClass('open');
        }
